...
class _FramePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_0_fill.color = const Color(0xff3A4245).withOpacity(1.0);
    canvas.drawRRect(
    ...
    paint_1_fill.color = const Color(0xff121515).withOpacity(1.0);
    canvas.drawRRect(
        RRect.fromRectAndCorners(
    ...
    paint_2_fill.color = const Color(0xff262C2D).withOpacity(1.0);
    ...
    paint_3_fill.color = const Color(0xff262C2D).withOpacity(1.0);
    ...
    paint_4_fill.color = const Color(0xff121515).withOpacity(1.0);
    ...
    paint_5_fill.color = const Color(0xff636F73).withOpacity(1.0);
