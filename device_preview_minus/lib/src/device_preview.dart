...
import 'package:device_preview_minus/src/frame/device_frame.dart';
import 'package:device_preview_minus/src/state/state.dart';
import 'package:device_preview_minus/src/state/store.dart';
import 'package:device_preview_minus/src/storage/storage.dart';
import 'package:device_preview_minus/src/utilities/assert_inherited_media_query.dart';
import 'package:device_preview_minus/src/utilities/media_query_observer.dart';
import 'package:device_preview_minus/src/views/theme.dart';
import 'package:device_preview_minus/src/views/tool_panel/sections/accessibility.dart';
import 'package:device_preview_minus/src/views/tool_panel/sections/device.dart';
import 'package:device_preview_minus/src/views/tool_panel/sections/settings.dart';
import 'package:device_preview_minus/src/views/tool_panel/sections/system.dart';
import 'package:device_preview_minus/src/views/tool_panel/tool_panel.dart';
...
class DevicePreview extends StatefulWidget {
  ...
  static bool _isEnabled(BuildContext context) {
    final state = context.findAncestorStateOfType<DevicePreviewState>();
